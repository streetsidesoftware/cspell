...
describe('Validate GlobMatcher', () => {
    tests().forEach(([patterns, root, filename, expected, description], index) => {
        it(`test ${index} ${description}, pattern: [${patterns}] filename: "${filename}", root: "${root}"`, () => {
            const matcher = new GlobMatcher_1.GlobMatcher(patterns, root);
            chai_1.expect(matcher.match(filename)).to.be.eq(expected);
        });
    });
});
function tests() {
    return [
        ...
        [['.vscode/'], '/User/code/src', '/User/code/src/.vscode/settings.json', true, 'With Root .vscode/'],
        [['.vscode/'], '/User/code/src', '/User/code/src/.vscode', true, 'With Root .vscode/'],
        ...
        [['.vscode/'], '/User/lib/src', '/User/code/src/.vscode', false, 'With non matching Root .vscode/'],
        ...
        [['.vscode/'], '/User/code/src/', '/User/code/src/.vscode/settings.json', true, '.vscode/'],
        [['.vscode/'], '/User/code/src/', '/User/code/src/.vscode', true, '.vscode/'],
