import {
    calcSettingsForLanguage,
    calcUserSettingsForLanguage,
...
describe('Validate LanguageSettings', () => {
    test('tests merging language settings', () => {
        ...
        const sPython = calcSettingsForLanguage(
            languageSettings,
            'python',
            'en'
        );
    ...
    test('tests that settings at language level are merged', () => {
        ...
        expect(sPython.ignoreRegExpList).toEqual(
    ...
    test('test merged settings with global', () => {
        ...
        const sPHP = calcSettingsForLanguage(
    ...
    test('tests matching languageIds', () => {
        const langSet = LS.normalizeLanguageId(
            'PHP; literate haskell, Python | cpp,javascript'
        );
