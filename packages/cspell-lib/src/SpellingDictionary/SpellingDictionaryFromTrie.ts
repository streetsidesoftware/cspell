...
export class SpellingDictionaryFromTrie implements SpellingDictionary {
    ...
    public has(word: string, hasOptions?: HasOptions): boolean {
        ...
        const useCompounds =
            searchOptions.useCompounds === undefined
                ? this.options.useCompounds
                : searchOptions.useCompounds;
    ...
    public genSuggestions(
        ...
        const _compoundMethod = this.options.useCompounds
        ...
        wordSearchForms(
            ...
            this.trie.genSuggestions(
                impersonateCollector(collector, w),
                _compoundMethod
            )
        );
    }
