...
//#endregion
//#region src/lib/Settings/DictionaryReferenceCollection.d.ts
/**
* A collection of dictionary references to determine if a dictionary is enabled or blocked.
*/
interface DictionaryReferenceCollection {
