...
describe('Validate InDocSettings', () => {
    ...
    it('tests extracting in file settings for compound words', () => {
        chai_1.expect(InDoc.getInDocumentSettings('')).to.deep.equal({ id: 'in-doc-settings' });
        chai_1.expect(InDoc.getInDocumentSettings('cSpell:enableCompoundWords').allowCompoundWords, 'cSpell:enableCompoundWords').to.be.true;
        chai_1.expect(InDoc.getInDocumentSettings('cSpell:ENABLECompoundWords').allowCompoundWords, 'cSpell:ENABLECompoundWords').to.be.true;
        chai_1.expect(InDoc.getInDocumentSettings('cSpell:disableCompoundWords').allowCompoundWords, 'cSpell:disableCompoundWords').to.be.false;
        chai_1.expect(InDoc.getInDocumentSettings('cSpell:disableCompoundWORDS').allowCompoundWords, 'cSpell:disableCompoundWORDS').to.be.false;
        ...
        chai_1.expect(InDoc.getInDocumentSettings(sampleText).allowCompoundWords).to.be.true;
