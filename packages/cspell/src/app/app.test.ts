...
describe('Validate cli', () => {
    ...
    test.each`
        ...
        ${'--continue-on-error - missing import'}      | ${[...rcFix('import/import-errors', 'missing.config.yaml'), '--continue-on-error', '*.md']}      | ${undefined}       | ${true}  | ${false} | ${false}
        ${'--continue-on-error - missing dict'}        | ${[...rcFix('import/import-errors', 'missing-dict.config.yaml'), '--continue-on-error', '*.md']} | ${app.CheckFailed} | ${true}  | ${false} | ${false}
        ${'--continue-on-error - import & spelling'}   | ${[...rcFix('import/import-errors', 'missing.config.yaml'), '--continue-on-error', '*.txt']}     | ${app.CheckFailed} | ${true}  | ${true}  | ${false}
