...
import HelpLint from '@site/src/components/help-lint.md';
...
Below are examples of each that include a custom dictionary definition. Both of them are equivalent. If you have both, CSpell will look for the `.json` file first.
