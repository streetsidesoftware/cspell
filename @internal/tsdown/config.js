import { defineConfig, defineConfig as defineConfig$1 } from "tsdown";
//#region config.ts
...
function createConfig(config) {
	if (Array.isArray(config)) return defineConfig$1(config.map((c) => ({
		...defaultConfig,
		...c
	})));
...
//#endregion
export { createConfig, defaultConfig, defaultDeps, defineConfig, deps };
