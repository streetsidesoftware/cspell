...
function getDictionary(settings) {
    ...
    const settingsDictionary = Promise.resolve(SpellingDictionary_2.createSpellingDictionary(words.concat(userWords)));
    return SpellingDictionary_1.createCollectionP([...spellDictionaries, settingsDictionary]);
}
