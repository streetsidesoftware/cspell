...
CSpell is a spell checker for code. This is a monorepo that contains the command-line tool and other related packages.

For more information about CSpell, please see the [online documentation](https://streetsidesoftware.github.io/cspell/).
